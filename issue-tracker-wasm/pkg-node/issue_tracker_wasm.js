 ...
 * @returns {any}
 */
function add_issue(state_json, title) {
 ...
 * @returns {any}
 */
function close_issue(state_json, issue_id) {
    const ptr0 = passStringToWasm0(state_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
function list_issues(state_json, status) {
    const ptr0 = passStringToWasm0(state_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.list_issues = list_issues;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./issue_tracker_wasm_bg.js": import0,
    };
}
...
const wasmPath = `${__dirname}/issue_tracker_wasm_bg.wasm`;
